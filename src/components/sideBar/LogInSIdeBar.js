...
const LogInSIdeBar= ({setNavigateSideBar}) => {
    ...
    const buttonListHendle = () => {
        setSideBarNavigation(false)
        setNavigateSideBar(true)
    }

    const buttonRateHendle = () => {
    ...
    return ( 
        <div className='bg-white w-[318px] h-[136px] rounded-md p-4'>
            <button className={buttonList} onClick={buttonListHendle} >
            ...
            <button  className={buttonRate} onClick={buttonRateHendle} >
