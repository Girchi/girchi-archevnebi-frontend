    ...
    return (
        <>
            ...
            <div className="flex flex-col py-10">
                ...
                <div className= "w-full border-t-2 flex py-6  items-center justify-between text-lightBlack font-[TBCContractica] text-xs font-medium">
                    ...
                    <div className="flex grow ml-3 mr-28 flex-col">
                        <label htmlFor="candidats">აირჩიე კანდიდატი</label>
                        <div className="mt-1.5 border-[1px] justify-between rounded-md py-3.5 px-3 text-sm">
                        <select className="w-full bg-white">
                                <option value="1">1 პოლიტიკოსის სახელი და გვარი</option>
                            </select>
                        </div>
                    </div>
